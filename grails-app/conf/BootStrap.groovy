...
class BootStrap {
  ...
  def init = { servletContext ->
    ...
    if (!SecUser.count()) {
      ...
      //Creating operations
      def op1 = new Operation(name: 'Колбасы', sum: 1000, user: user, category: ctg7, type: 0, bill: bill1, startDate: new Date(111, 6, 7), endDate: new Date(111, 6, 10)).save(failOnError: true)
      def op2 = new Operation(name: 'Вертолёт', sum: 2000, user: user, category: ctg7, type: 1, bill: bill2, startDate: new Date(111, 6, 8), endDate: new Date(111, 6, 8)).save(failOnError: true)
      def op3 = new Operation(name: 'Car', sum: 5000, user: user, category: ctg7, type: 1, bill: bill3, startDate: new Date(111, 6, 11), endDate: new Date(111, 6, 12)).save(failOnError: true)
      def op4 = new Operation(name: 'bear', sum: 4000, user: user, category: ctg7, type: 0, bill: bill3, startDate: new Date(111, 6, 13), endDate: new Date(111, 6, 13)).save(failOnError: true)
      def op5 = new Operation(name: 'dog house', sum: 1000, user: user, category: ctg7, type: 1, bill: bill5, startDate: new Date(111, 6, 4), endDate: new Date(111, 6, 5)).save(failOnError: true)

                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="settings.currency.label" default="Currency" /></th>
                        
                            <g:sortableColumn property="name" title="${message(code: 'settings.name.label', default: 'Name')}" />
                    ...
                    <g:each in="${settingsInstanceList}" status="i" var="settingsInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: settingsInstance, field: "currency")}</td>
                        
                            <td>${fieldValue(bean: settingsInstance, field: "name")}</td>

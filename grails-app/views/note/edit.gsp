                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="value"><g:message code="note.value.label" default="Value" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: noteInstance, field: 'value', 'errors')}">
                                    <g:textArea name="value" cols="40" rows="5" value="${noteInstance?.value}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="name"><g:message code="note.name.label" default="Name" /></label>
                                </td>
